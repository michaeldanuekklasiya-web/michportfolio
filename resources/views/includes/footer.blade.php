<footer id="footer" class="bg-white py-8 px-4 md:px-8 lg:px-12">
    <div class="container mx-auto max-w-7xl">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Logo and Description -->
            <div class="col-span-1 md:col-span-1 lg:col-span-1 text-center md:text-left lg:text-left">
                ...
                <div class="mt-4 text-center sm:text-left">
                    <p class="text-gray-600 text-sm mb-2">Follow our socials</p>
                    <div class="flex justify-center sm:justify-start space-x-4">
                        <a href="#" class="text-gray-600 hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30" class="w-5 h-5">
            ...
            <div class="hidden md:block col-span-1">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-600 hover:text-gray-900">Blog and Articles</a></li>
